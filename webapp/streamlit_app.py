...
with st.form("prediction_form"):
    ...
    submit = st.form_submit_button("Predict With and Without Bias Mitigation", use_container_width=True)
...
comparison_rows = [
    {
        ...
        **metrics["without_bias_mitigation"],
    },
    {
        "Model": "With Bias Mitigation (Reweighing)",
        **metrics["with_bias_mitigation_reweighing"],
    },
]
